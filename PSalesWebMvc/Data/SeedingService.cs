...
{
    //Serve para popular as tabelas no banco ao invés de usar o Add-Migration
//será incluído na class Startup( sistema de injeção de dependência) para outros serviços possam injetar nele e ele em outros
    public class SeedingService
    {
        private PSalesWebMvcContext _context;

       //construtor para indicar que o sistema de injeção deve acontecer
        public SeedingService(PSalesWebMvcContext context )
        {
            _context = context;
        }

      //operação para popular o BD
        public void Seed()//depois esse método será inserido em configure da class Startup
        {
